...
- Condiciones publicadas: ~~35.000-40.000 € fijos + 15 % variable~~ → **rango abierto sujeto a la valía y experiencia del candidato, más variable por objetivos** (decisión 2026-09-14, sin cifra en la web; en Nova/outreach sí se comunica 35-40k) + posibilidad de plan de acciones. ~~Madrid centro (Cuzco), híbrido~~ → **indistinto: full remote desde España o presencial en Madrid** (decisión 2026-09-11 para ampliar el pool fuera de Madrid y ajustar salario; subtítulo público lo indica).
