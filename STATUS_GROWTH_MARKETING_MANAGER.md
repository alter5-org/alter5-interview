...
- Condiciones publicadas: 35.000-40.000 € fijos + 15 % variable + posibilidad de plan de acciones. ~~Madrid centro (Cuzco), híbrido~~ → **indistinto: full remote desde España o presencial en Madrid** (decisión 2026-09-11 para ampliar el pool fuera de Madrid y ajustar salario; subtítulo público lo indica).
